...
//    private NearbyDrivers mNearbyDrivers;
    ...
    public void enterState(MapActivityNew activity, Bundle data) {
        ...
        gpsTracker = mActivity.getGpstTacker();
        initialize();
    }
    ...
    private void initialize() {
        ...
        gpsTracker.stopLocationTracking();


        //update driver state
        Driver driver = (Driver) ParseUser.getCurrentUser();
        driver.put(Driver.STATE, StateManager.States.Inactive.toString());
...
//        fm.updateControlText();

//        FragmentTransaction ft = mActivity.getSupportFragmentManager().beginTransaction();
//        ft.replace(R.id.fmControls, ControlsFragment.newInstance(), "controls");
//        ft.commit();
